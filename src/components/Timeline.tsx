...
const steps = [
  {
    ...
    icon: 'MessageSquare',
    title: 'Заявка',
    description: 'Вы оставляете заявку, менеджер связывается в течение 15 минут. Уточняем детали и принимаем оплату.',
    color: '#e2e8f0',
  },
  {
    day: 'Шаг 2',
    icon: 'Palette',
    title: 'Создание наклейки',
    description: 'Дизайнер создаёт макет с вашим профилем и адресной лентой.',
    color: '#94a3b8',
  },
  {
    day: 'Шаг 3',
    icon: 'Layers',
    title: 'Монтаж',
    description: 'Монтаж подсветки и вашей индивидуальной наклейки на зеркало.',
    color: '#94a3b8',
  },
  {
    day: 'Шаг 4',
    icon: 'Package',
    title: 'Сборка',
    description: 'Направляем фото материал готового зеркала + зеркала в транспортировочном коробе.',
    color: '#64748b',
  },
  {
    day: 'Шаг 5',
