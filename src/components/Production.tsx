...
const qualities = [
  ...
  },
  {
    icon: 'Zap',
    title: 'LED-подсветка',
    description: 'Светодиодная лента 120 диодов/м холодного свечения. Равномерный яркий свет без теней — идеально для макияжа и ежедневных ритуалов.',
  },
  {
    icon: 'Shield',
    title: 'Надёжный каркас',
    description: 'Алюминиевый профиль обеспечивает жёсткость конструкции. Зеркало не деформируется со временем.',
  },
  {
    icon: 'Printer',
    title: 'Точная печать',
